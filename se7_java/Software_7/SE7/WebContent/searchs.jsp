    ...
    <div class="container py-5">
        <div class="row">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
						<% 
							ArrayList<scoreboard> SboardList = userdao.getSearchS(request.getParameter("searchoption"), request.getParameter("searchtext"));
						...
						<td><a href="QNAview.jsp?Qnumber=<%=SboardList.get(i).getEnumber()%>"><%=SboardList.get(i).getTitle().replaceAll(" ","&nbsp;").replaceAll("<","&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>")%></a></td>
