    ...
    <div class="container py-5">
		...
		<!-- End Search -->
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
						<% 
							ArrayList<dicboard> DboardList = userdao.getSearchd(request.getParameter("searchoption"), request.getParameter("searchtext"));
						...
						%>
						<tr>
						<td><%=DboardList.get(i).getDnumber()%></td>
						<td><a href="dicview.jsp?Dnumber=<%=DboardList.get(i).getDnumber()%>"><%=DboardList.get(i).getTitle().replaceAll(" ","&nbsp;").replaceAll("<","&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>")%></a></td>
						<td><%=userdao.getNick(DboardList.get(i).getUserID())%></td>
						</tr>
						<%
							}
						%>
